...
function submitScore(event) {
    ...
    // If a the same user/score pair is already on the leaderboard, ignore it
    // for (const score in highScores){
    //     if (score.userInitials === userScore.userInitials && score.userPoints === userScore.userPoints) {
    //         console.log("Found replicate score");
    //         scoreHelper();
    //         return;
    //     }
    // }
